defmodule AvcKoombeaWebscraperWeb.UserAuthTest do
  use AvcKoombeaWebscraperWeb.ConnCase

  alias AvcKoombeaWebscraper.Accounts
  alias AvcKoombeaWebscraper.Accounts.Scope
  alias AvcKoombeaWebscraperWeb.UserAuth

  import AvcKoombeaWebscraper.AccountsFixtures

  @remember_me_cookie "_avc_koombea_webscraper_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AvcKoombeaWebscraperWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
